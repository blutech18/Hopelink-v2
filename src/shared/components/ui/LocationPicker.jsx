...
const LocationPicker = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-3 sm:p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-3xl w-full border border-blue-100 flex flex-col" style={{maxHeight: 'min(90vh, 700px)', height: 'min(90vh, 700px)'}}>
        {/* Header */}
        <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-blue-800 to-blue-900 rounded-t-xl flex-shrink-0">
          <div>
            <h2 className="text-base sm:text-lg font-semibold text-white">{title}</h2>
            <p className="text-xs text-blue-200">Click on the map or search for a location</p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="space-y-3">
              ...
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                  ...
                  {!isOfflineMode ? (
                    ...
                    >
                      <input
                        ...
                        className="w-full pl-8 pr-3 py-2 bg-white border border-blue-200 text-gray-900 placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                      />
                    </Autocomplete>
                  ) : (
                    <input
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-3 py-2 bg-blue-700 text-white font-semibold rounded-lg hover:bg-blue-600 transition-colors flex items-center justify-center space-x-2 disabled:opacity-50 text-sm"
                >
              ...
              <div className="bg-blue-50 p-2 rounded-lg border border-blue-200">
                {mapsApiLoaded ? (
                  <p className="text-xs text-blue-700">
                    <strong className="text-blue-900">Tip:</strong> Drag the marker or click the map to set position.
                  </p>
                ) : (
                  <div className="space-y-2">
                    <p className="text-xs text-blue-700">
                      <strong className="text-blue-900">Manual Location Selection:</strong> Since Google Maps is unavailable, you can:
                    </p>
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row gap-3 p-3 sm:p-4 border-t border-blue-100 bg-blue-50 rounded-b-xl flex-shrink-0">
          <button
            onClick={onClose}
            className="w-full sm:flex-1 px-4 py-2.5 sm:py-2 border border-blue-300 text-blue-700 bg-white rounded-lg hover:bg-blue-50 transition-colors text-sm font-medium order-2 sm:order-1"
          >
            Cancel
          </button>
          <button
            ...
            className="w-full sm:flex-1 bg-blue-700 hover:bg-blue-800 text-white px-4 py-2.5 sm:py-2 rounded-lg transition-all disabled:opacity-50 flex items-center justify-center space-x-2 text-sm font-semibold shadow-md hover:shadow-lg active:scale-95 order-1 sm:order-2"
          >
