...
// Donor pages
const importPostDonationPage = () =>
  import("./modules/donor/pages/PostDonationPage");
const importFulfillRequestPage = () =>
  import("./modules/donor/pages/FulfillRequestPage");
const importMyDonationsPage = () =>
  import("./modules/donor/pages/MyDonationsPage");
const importBrowseRequestsPage = () =>
  import("./modules/donor/pages/BrowseRequestsPage");
const importPendingRequestsPage = () =>
  import("./modules/donor/pages/PendingRequestsPage");
...
// Recipient pages
const importBrowseDonationsPage = () =>
  import("./modules/recipient/pages/BrowseDonationsPage");
const importCreateRequestPage = () =>
  import("./modules/recipient/pages/CreateRequestPage");
const importMyRequestsPage = () =>
  import("./modules/recipient/pages/MyRequestsPage");
const importMyApprovedDonationsPage = () =>
  import("./modules/recipient/pages/MyApprovedDonationsPage");
const importMyApprovedRequestsPage = () =>
  import("./modules/recipient/pages/MyApprovedRequestsPage");
...
// Volunteer pages
const importVolunteerDashboardPage = () =>
  import("./modules/volunteer/pages/VolunteerDashboardPage");
const importAvailableTasksPage = () =>
  import("./modules/volunteer/pages/AvailableTasksPage");
const importMyDeliveriesPage = () =>
  import("./modules/volunteer/pages/MyDeliveriesPage");
const importVolunteerSchedulePage = () =>
  import("./modules/volunteer/pages/VolunteerSchedulePage");
...
// Admin pages
const importAdminDashboard = () =>
  import("./modules/admin/pages/AdminDashboard");
const importUserManagementPage = () =>
  import("./modules/admin/pages/UserManagementPage");
const importIDVerificationPage = () =>
  import("./modules/admin/pages/IDVerificationPage");
const importAdminSettingsPage = () =>
  import("./modules/admin/pages/AdminSettingsPage");
const importMatchingParametersPage = () =>
  import("./modules/matching/pages/MatchingParametersPage");
const importAdminDonationsPage = () =>
  import("./modules/admin/pages/AdminDonationsPage");
const importAdminCFCDonationsPage = () =>
  import("./modules/admin/pages/AdminCFCDonationsPage");
const importAdminVolunteersPage = () =>
  import("./modules/admin/pages/AdminVolunteersPage");
const importAdminRequestsPage = () =>
  import("./modules/admin/pages/AdminRequestsPage");
const importAdminEventsPage = () =>
  import("./modules/admin/pages/AdminEventsPage");
const importAdminFeedbackPage = () =>
  import("./modules/admin/pages/AdminFeedbackPage");
...
// Legal pages
const importTermsOfServicePage = () =>
  import("./modules/legal/pages/TermsOfServicePage");
const importPrivacyPolicyPage = () =>
  import("./modules/legal/pages/PrivacyPolicyPage");
const importCookiesPolicyPage = () =>
  import("./modules/legal/pages/CookiesPolicyPage");
const importCodeOfConductPage = () =>
  import("./modules/legal/pages/CodeOfConductPage");
...
const ProtectedRoute = ({ children, allowedRoles }) => {
  ...
  React.useEffect(() => {
    if (
      ...
      console.error(
        "🚨 Suspended account detected in ProtectedRoute - redirecting to login",
      );
...
function AppContent() {
  ...
  useEffect(() => {
    ...
    if (isDevelopment) {
      ...
      if (!envStatus.isConfigured) {
        ...
        showToast(
          "Environment configuration needed for full functionality",
          "warning",
        );
      }
    }
  ...
  useEffect(() => {
      ...
      try {
        ...
        navigate(
          new URL(redirectTo).pathname +
            (new URL(redirectTo).search || "") +
            (new URL(redirectTo).hash || ""),
          { replace: true },
        );
        return;
      }
    ...
    const { data: subscription } = supabase.auth.onAuthStateChange((event) => {
      if (event === "PASSWORD_RECOVERY") {
        ...
        navigate(
          `/reset-password${hash || search ? "" : ""}${hash}${!hash && search ? search : ""}`,
          { replace: true },
        );
      }
    });
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-950">
      ...
      <div
        className={`transition-all duration-300 ease-in-out ${getSidebarMargin()}`}
      >
