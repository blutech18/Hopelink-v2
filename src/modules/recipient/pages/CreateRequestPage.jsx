      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="text-xs px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-yellow-600 hover:to-yellow-700 text-white rounded-lg font-medium transition-all inline-flex items-center gap-2 flex-shrink-0 self-center"
                >
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
            ...
            <div className="card px-6 py-10 sm:py-11 lg:px-8 lg:py-12 xl:py-14 border-2 border-gray-200 shadow-2xl lg:sticky lg:top-20 rounded-xl" className="bg-gray-50">
              ...
              <div className="flex items-center justify-between mb-10 sm:mb-11 lg:mb-12 pb-7 sm:pb-8 lg:pb-9 border-b border-gray-200">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-gray-50 hover:bg-gray-100 text-blue-500 hover:text-gray-600 transition-all"
                        ...
                        <div className="flex-shrink-0">
                          <motion.div
                            ...
                            className={`relative flex items-center justify-center w-14 h-14 lg:w-16 lg:h-16 rounded-full border-2 transition-all duration-300 ${
                              isActive
                                ? 'bg-gradient-to-br from-blue-600 to-blue-700 border-yellow-400 text-white shadow-lg shadow-yellow-500/50'
                                : isCompleted
                          ...
                          >
                            ...
                            {isActive && (
                              <motion.div
                                ...
                                className="absolute inset-0 rounded-full bg-yellow-400/30 border-2 border-blue-200"
                              />
                            )}
                          </motion.div>
                        </div>
          ...
          <motion.div
            ...
            ref={formTopRef}
          >
            <div className="card p-6 sm:p-8 md:p-10 lg:p-12 border-2 border-gray-200 shadow-2xl" className="bg-gray-50">
          <form onSubmit={(e) => {
            if (currentStep !== 3) {
              e.preventDefault()
              return
                    ...
                    <div className="bg-gradient-to-br from-navy-800/50 to-navy-900/50 rounded-xl border-2 border-gray-300/50 shadow-xl overflow-hidden">
                      ...
                      <div className="bg-gray-50/50 px-6 py-4 border-b-2 border-gray-200">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="text-xs text-blue-500/70 font-semibold uppercase tracking-wider mb-2">Request Information</div>
                      ...
                      {watch('description') && (
                        <div className="px-6 py-5 border-b border-gray-200/50">
                          <div className="text-xs text-blue-500/70 font-semibold uppercase tracking-wider mb-2">Description</div>
                      ...
                      <div className="px-6 py-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                          {/* Category */}
                          <div className="space-y-2">
                            <div className="text-xs text-blue-500/70 font-semibold uppercase tracking-wider">Category</div>
                            <div className="text-base text-white font-medium">{watch('category') || 'Not specified'}</div>
                          </div>

                          {/* Quantity */}
                          <div className="space-y-2">
                            <div className="text-xs text-blue-500/70 font-semibold uppercase tracking-wider">Quantity Needed</div>
                            <div className="text-base text-white font-medium">{watch('quantity_needed') || 1} {watch('quantity_needed') === 1 ? 'item' : 'items'}</div>
                          </div>

                          {/* Urgency */}
                          <div className="space-y-2">
                            <div className="text-xs text-blue-500/70 font-semibold uppercase tracking-wider">Urgency Level</div>
                            <div className={`inline-flex items-center px-3 py-1.5 rounded-md text-sm font-medium ${
                              ...
                              watchedUrgency === 'medium' ? 'bg-yellow-900/40 text-gray-600 border border-yellow-500/40' :
                      ...
                      {(watch('delivery_instructions') || watch('tags')) && (
                        <div className="border-t border-gray-200/50">
                          {watch('delivery_instructions') && (
                            <div className="px-6 py-5 border-b border-gray-200/50">
                              <div className="text-xs text-blue-500/70 font-semibold uppercase tracking-wider mb-2">Delivery Instructions</div>
                              <p className="text-sm text-gray-200 leading-relaxed whitespace-pre-wrap">{watch('delivery_instructions')}</p>
                            </div>
                          )}
                          {watch('tags') && (
                            <div className="px-6 py-5">
                              <div className="text-xs text-blue-500/70 font-semibold uppercase tracking-wider mb-3">Tags</div>
                              <div className="flex flex-wrap gap-2">
                                {watch('tags').split(',').map((tag, idx) => tag.trim()).filter(tag => tag).map((tag, idx) => (
                                  <span key={idx} className="inline-flex items-center px-3 py-1.5 rounded-md text-xs bg-amber-50 text-gray-600 border border-gray-200 font-medium">
                                    {tag.trim()}
                                  </span>
                                ))}
                              </div>
            ...
            {/* Navigation Buttons */}
            <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 mt-8 pt-6 border-t-2 border-gray-200">
              <button
                type="button"
                onClick={prevStep}
                disabled={currentStep === 1}
                className="w-full sm:w-auto px-6 py-3 bg-gray-100 hover:bg-gray-200 text-white rounded-lg text-sm font-medium transition-all flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-gray-100 shadow-lg hover:shadow-xl order-2 sm:order-1"
              >
