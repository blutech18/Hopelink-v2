        ...
        >
          <div className="flex items-center justify-between gap-3 sm:gap-4 mb-6">
            <div className="min-w-0">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">Direct Donations</h1>
              <p className="text-gray-500 text-xs sm:text-sm">Manage donations directly to organization</p>
            </div>
          ...
          <div className="flex flex-col gap-3 sm:gap-4 mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="w-full sm:w-auto px-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm sm:text-base font-medium transition-all border-2 border-gray-200 hover:border-blue-400 flex items-center justify-center gap-2"
              >
          ...
          <div className="card p-4 sm:p-6">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-gray-500 text-xs sm:text-sm">Total Direct Donations</p>
              </div>
            </div>
          </div>
                  ...
                  return (
                    ...
                    >
                      <td className="px-4 py-2.5">
                        <div className="flex items-center gap-2">
                          <span className="text-sm font-medium text-gray-900 truncate max-w-xs">{donation.title}</span>
                        </div>
                      </td>
                      
                      <td className="px-4 py-2.5 text-center">
                        <div className="text-xs text-gray-900 truncate max-w-xs">{donation.donor?.name || 'Unknown'}</div>
                      </td>
                      ...
                      <td className="px-4 py-2.5 text-center">
                        <div className="flex items-center justify-center gap-1.5">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded transition-all active:scale-95"
                            title="View Details"
                          >
      ...
      {showModal && selectedDonation && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setShowModal(false)}>
          <motion.div
            ...
            className="bg-white border border-gray-200 shadow-2xl rounded-xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col"
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200 flex-shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Direct Donation Details</h3>
                  ...
                  {selectedDonation.donor?.phone_number && (
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <label className="text-sm font-semibold text-gray-600">Donor Phone</label>
                      </div>
                      <p className="text-gray-900 text-lg font-medium">{selectedDonation.donor.phone_number}</p>
                    </div>
                  )}
                </div>
