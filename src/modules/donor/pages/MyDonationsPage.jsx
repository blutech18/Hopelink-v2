...
const MyDonationsPage = () => {
  ...
  const [confirmingDirectDeliveryId, setConfirmingDirectDeliveryId] =
    useState(null);

  // Report user states
  const [showReportModal, setShowReportModal] = useState(false);
  const [reportUser, setReportUser] = useState(null);
  const [reportTransactionContext, setReportTransactionContext] =
    useState(null);
  ...
  const handleEditDonation = (donation) => {
    ...
    setSelectedDonation(donation);
    setImagePreview(
      donation.images && donation.images.length > 0 ? donation.images[0] : null,
    );
    setUploadedImage(null);
    ...
    reset({
      ...
      expiry_date: donation.expiry_date
        ? new Date(donation.expiry_date).toISOString().split("T")[0]
        : "",
  ...
  const handleDirectDeliveryConfirmation = async (notification) => {
    try {
      ...
      error(
        "Failed to complete direct delivery transaction. Please try again.",
      );
    } finally {
  ...
  const getStatusColor = (status, donation) => {
    ...
    const colors = {
      available:
        "bg-green-100 text-green-800 border-green-300 dark:bg-success-900/70 dark:text-white dark:border-transparent",
      matched:
        "bg-yellow-100 text-yellow-800 border-yellow-300 dark:bg-yellow-900/70 dark:text-white dark:border-transparent",
      donated:
        "bg-blue-100 text-blue-800 border-blue-300 dark:bg-blue-900/70 dark:text-white dark:border-transparent",
      claimed:
        "bg-amber-100 text-amber-800 border-amber-300 dark:bg-amber-900/70 dark:text-white dark:border-transparent",
      in_transit:
        "bg-purple-100 text-purple-800 border-purple-300 dark:bg-purple-900/70 dark:text-white dark:border-transparent",
      delivered:
        "bg-emerald-100 text-emerald-800 border-emerald-300 dark:bg-emerald-900/70 dark:text-white dark:border-transparent",
      completed:
        "bg-green-100 text-green-800 border-green-400 dark:bg-green-500/70 dark:text-white dark:border-green-500/50",
      cancelled:
        "bg-red-100 text-red-800 border-red-300 dark:bg-danger-900/70 dark:text-white dark:border-transparent",
      expired:
        "bg-gray-100 text-gray-800 border-gray-300 dark:bg-gray-900/70 dark:text-white dark:border-transparent",
    };
    ...
    if (donation?.donation_destination === "organization") {
      const directStatusColors = {
        available:
          donation?.delivery_mode === "donor_delivery"
            ? "bg-blue-100 text-blue-800 border-blue-300 dark:bg-blue-900/70 dark:text-white dark:border-transparent"
            : donation?.delivery_mode === "organization_pickup"
              ? "bg-purple-100 text-purple-800 border-purple-300 dark:bg-purple-900/70 dark:text-white dark:border-transparent"
        ...
        delivered:
          "bg-green-100 text-green-800 border-green-300 dark:bg-green-900/70 dark:text-white dark:border-transparent",
        claimed:
          "bg-emerald-100 text-emerald-800 border-emerald-300 dark:bg-emerald-900/70 dark:text-white dark:border-transparent",
      };
      return (
        directStatusColors[status] ||
        colors[status] ||
        "bg-gray-100 text-gray-800 border-gray-300 dark:bg-gray-900/70 dark:text-white dark:border-transparent"
      );
    }
  ...
  const stats = {
    ...
    claimed: donations.filter((d) =>
      ["claimed", "in_transit"].includes(d.status),
    ).length,
    completed: donations.filter((d) =>
            ...
            <div className="card p-2.5 sm:p-4 lg:p-6 border border-gray-200 bg-white rounded-xl shadow-sm">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex flex-col items-center gap-0.5">
                  ...
                  <span className="text-[10px] sm:hidden text-blue-600 font-medium">
                    Gifts
                  </span>
                </div>
              </div>
            ...
            <div className="card p-2.5 sm:p-4 lg:p-6 border border-gray-200 bg-white rounded-xl shadow-sm">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex flex-col items-center gap-0.5">
                  ...
                  <span className="text-[10px] sm:hidden text-green-600 font-medium">
                    Ready
                  </span>
                </div>
              </div>
            ...
            <div className="card p-2.5 sm:p-4 lg:p-6 border border-gray-200 bg-white rounded-xl shadow-sm">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex flex-col items-center gap-0.5">
                  ...
                  <span className="text-[10px] sm:hidden text-amber-600 font-medium">
                    Active
                  </span>
                </div>
              </div>
            ...
            <div className="card p-2.5 sm:p-4 lg:p-6 relative overflow-hidden border border-gray-200 bg-white rounded-xl shadow-sm">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex flex-col items-center gap-0.5">
                  ...
                  <span className="text-[10px] sm:hidden text-emerald-600 font-medium">
                    Done
                  </span>
                </div>
              </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Recipients have confirmed receipt - mark as complete
                    </p>
                  </div>
                </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">
                      Confirm Pickup Completions
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Self-pickup donations ready for final confirmation
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Direct delivery coordination and updates
                    </p>
                  </div>
                </div>
                      ...
                      <div>
                        ...
                        <p className="text-orange-600 text-xs mt-1">
                          {notification.data?.delivery_address &&
                            `Address: ${notification.data.delivery_address}`}
                        </p>
                      </div>
                    </div>
                    <button
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">
                      Confirm Direct Delivery Completions
                    </h3>
                    <p className="text-gray-600 text-sm">
                      Direct deliveries ready for final confirmation
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                {directDeliveryConfirmationNotifications.map((notification) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        handleDirectDeliveryConfirmation(notification)
                      }
                      disabled={
                        confirmingDirectDeliveryId ===
                        notification.data.claim_id
                      }
                      className="btn btn-success text-sm px-4 py-2 flex items-center"
                    >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {(searchTerm ||
                ...
                <span className="text-xs sm:text-sm text-blue-700 bg-blue-100 px-2 sm:px-3 py-1 rounded-full">
                  {filteredDonations.length} result
                ...
                {filteredDonations.map((donation, index) => {
                  ...
                  return (
                    <div key={donation.id} className="relative">
                      ...
                      {showStatusSection && (
                        <div
                          className="px-3 py-2 bg-gradient-to-r from-primary-700 via-primary-800 to-primary-700 border-l-2 border-t-2 border-r-2 border-b-0 border-primary-500/70 rounded-t-lg mb-0 relative z-10"
                          style={{
                      ...
                      <motion.div
                        ...
                        style={{
                          borderTopLeftRadius: showStatusSection
                            ? "0"
                            : undefined,
                          borderTopRightRadius: showStatusSection
                            ? "0"
                            : undefined,
                          ...
                          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                              ...
                              {donation.images && donation.images.length > 0 ? (
                                <div className="relative w-full sm:w-56 lg:w-64 h-48 sm:h-56 lg:h-64 rounded-lg overflow-hidden border border-gray-200 shadow-lg">
                                  ...
                                  <div className="absolute top-2 right-2">
                                    <span
                                      className={`px-2 py-0.5 sm:py-1 rounded-md text-[10px] sm:text-xs font-semibold backdrop-blur-md border-2 shadow-lg ${getStatusColor(donation.status, donation)}`}
                                    >
                                      {donation.description?.includes(
                                        "Donation for request:",
                                ...
                                <div className="w-full sm:w-56 lg:w-64 h-48 sm:h-56 lg:h-64 rounded-lg bg-gradient-to-br from-gray-100 to-gray-200 flex flex-col items-center justify-center border-2 border-gray-200 shadow-lg">
                                  ...
                                  <span
                                    className={`mt-2 px-2 py-0.5 sm:py-1 rounded-md text-[10px] sm:text-xs font-semibold ${getStatusColor(donation.status, donation)}`}
                                  >
                                    {donation.status
                                      .replace("_", " ")
                                      .toUpperCase()}
                            ...
                            <div className="flex-1 space-y-2 sm:space-y-3">
                              ...
                              <div className="flex flex-col sm:flex-row items-start justify-between gap-3 sm:gap-4">
                                <div className="flex-1 min-w-0">
                                  <h3 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 mb-1.5 sm:mb-2">
                                    {donation.title}
                                  </h3>
                                  ...
                                  <p className="text-gray-600 text-xs sm:text-sm line-clamp-2">
                                    {donation.description?.startsWith(
                                      "Donation for request:",
                                    )
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-gray-50/30 rounded-lg p-4 border border-gray-200">
                        <div className="flex items-center justify-between">
                          ...
                          <span
                            className={`text-lg font-medium ${selectedDonation.quantity != null ? "text-gray-900" : "text-gray-600 italic"}`}
                          >
                            {selectedDonation.quantity != null
                      ...
                      <div className="bg-gray-50/30 rounded-lg p-4 border border-gray-200">
                        <div className="flex items-center justify-between">
                          ...
                          <span
                            className={`text-lg font-medium ${selectedDonation.condition ? "text-gray-900 capitalize" : "text-gray-600 italic"}`}
                          >
                    ...
                    <div className="bg-gray-50/30 rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`text-center max-w-[60%] break-words ${selectedDonation.pickup_location ? "text-gray-900" : "text-gray-600 italic"}`}
                        >
                    ...
                    <div className="bg-gray-50/30 rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`text-center max-w-[60%] break-words ${selectedDonation.pickup_instructions ? "text-gray-900" : "text-gray-600 italic"}`}
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-gray-50/30 rounded-lg p-4 border border-gray-200">
                        <div className="flex items-center justify-between">
                          ...
                          <span
                            className={`text-lg font-medium ${selectedDonation.delivery_mode ? "text-gray-900" : "text-gray-600 italic"}`}
                          >
                            {selectedDonation.delivery_mode
                              ? selectedDonation.delivery_mode === "pickup"
                                ? "Self Pickup"
                                : selectedDonation.delivery_mode === "volunteer"
                                  ? "Volunteer Delivery"
                                  : selectedDonation.delivery_mode === "direct"
                                    ? "Direct Delivery"
                                    : selectedDonation.delivery_mode ===
                                        "donor_delivery"
                                      ? "Donor Delivery"
                    ...
                    <div className="bg-gray-50/30 rounded-lg p-4 border border-gray-200">
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`text-lg font-medium ${selectedDonation.expiry_date ? "text-gray-900" : "text-gray-600 italic"}`}
                        >
                    ...
                    {selectedDonation.status === "completed" &&
                      donationClaims[selectedDonation.id] &&
                      donationClaims[selectedDonation.id].length > 0 && (
                        <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                          ...
                          <div className="space-y-3">
                            {donationClaims[selectedDonation.id].map(
                              (claim, idx) => (
                                <div
                                  key={claim.id || idx}
                                  className="bg-gray-50/50 rounded-lg p-3 space-y-2"
                                >
                                  {/* Recipient Info */}
                                  {claim.recipient &&
                                    claim.recipient.id !== user?.id && (
                                      <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                          <User className="h-4 w-4 text-blue-400" />
                                          <div>
                                            <p className="text-white text-sm font-medium">
                                              Recipient: {claim.recipient.name}
                                            </p>
                                  ...
                                  {/* Volunteer Info */}
                                  {claim.delivery?.[0]?.volunteer &&
                                    claim.delivery[0].volunteer.id !==
                                      user?.id && (
                                      <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                          ...
                                          <div>
                                            <p className="text-white text-sm font-medium">
                                              Volunteer:{" "}
                                              {claim.delivery[0].volunteer.name}
                                            </p>
                                            <p className="text-gray-700 text-xs">
                                              {
                                                claim.delivery[0].volunteer
                                        ...
                                        <button
                                          onClick={() => {
                                            setReportUser({
                                              id: claim.delivery[0].volunteer
                                                .id,
                                              name: claim.delivery[0].volunteer
                                                .name,
                                              role:
                                                claim.delivery[0].volunteer
                                                  .role || "volunteer",
                      ...
                      <div className="md:col-span-2">
                        <label className="flex items-center cursor-pointer">
                          ...
                          <span className="text-sm text-white">
                            Mark as urgent (recipients will see this donation
                            prioritized)
                          </span>
                        </label>
                      </div>
