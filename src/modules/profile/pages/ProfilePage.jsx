...
const ProfilePage = () => {
  ...
  const handleImageSelect = async (event) => {
    ...
    try {
      ...
      const { uploadFile, validateFile } = await import('@/shared/lib/storageHelper')
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            <div className={`flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-gray-100 border border-gray-200`}>
              ...
              <span className="text-xs sm:text-sm font-medium text-gray-900 capitalize">{profile.role}</span>
            </div>
            {profile.account_type === 'business' && (
              <div className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-gray-100 border border-gray-200">
                <Building2 className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-yellow-600" />
                <span className="text-xs sm:text-sm font-medium text-gray-900">Business Account</span>
              </div>
            )}
            {/* Verification Status Badge */}
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-orange-50 border border-orange-200">
                <AlertCircle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-orange-600" />
                  <span className="text-xs sm:text-sm font-medium text-orange-700">Unverified</span>
                </div>
              )}
            {/* Derived Badges */}
            {Array.isArray(badges) && badges.length > 0 && (
              <div className="flex flex-wrap items-center gap-2">
                {badges.map((b) => (
                  <div key={b} className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 rounded-full bg-gray-100 border border-gray-200">
                    <Shield className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-yellow-600" />
                    <span className="text-xs sm:text-sm font-medium text-gray-700">{b}</span>
                  </div>
                ))}
              </div>
            )}
                ...
                >
                  <Award
                    className={`h-3.5 w-3.5 sm:h-4 sm:w-4 ${
                      completedEventsCount > 0 ? 'text-green-600' : 'text-gray-500'
                    }`}
                  />
                  <span
                    className={`text-xs sm:text-sm font-medium ${
                      completedEventsCount > 0 ? 'text-green-700' : 'text-gray-700'
                    }`}
                  >
          ...
          >
            <div className="flex items-center justify-between gap-3">
              <div className="flex-1">
                <div className="text-xs sm:text-sm text-gray-600 mb-1 font-medium">Profile Completion</div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-gray-900 min-w-[2.5rem] text-right">{completionPercentage}%</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
            ...
            <div className="flex-1 w-full text-center sm:text-left">
              <div className="mb-3 sm:mb-4">
                <p className="text-gray-900 font-medium mb-1 sm:mb-2 text-sm sm:text-base">Upload a profile picture</p>
                ...
                <div className="border-b border-gray-200 pb-4 mb-6">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">Your residential or business location</p>
                    </div>
                    <button
                      type="button"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <div className="input bg-gray-50">
                        <span className={profile.province ? 'text-gray-600' : 'text-gray-400 italic'}>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <div className="input bg-gray-50">
                        <span className={profile.city ? 'text-gray-600' : 'text-gray-400 italic'}>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <div className="input bg-gray-50">
                        <span className={profile.address_barangay ? 'text-gray-600' : 'text-gray-400 italic'}>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <div className="input bg-gray-50">
                        <span className={profile.address_street ? 'text-gray-600' : 'text-gray-400 italic'}>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <div className="input bg-gray-50">
                        <span className={profile.address_house ? 'text-gray-600' : 'text-gray-400 italic'}>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <div className="input bg-gray-50">
                        <span className={profile.address_subdivision ? 'text-gray-600' : 'text-gray-400 italic'}>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <div className="input bg-gray-50">
                        <span className={profile.zip_code ? 'text-gray-600' : 'text-gray-400 italic'}>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <div className="input bg-gray-50">
                        <span className={profile.address_landmark ? 'text-gray-600' : 'text-gray-400 italic'}>
                      ...
                      {/* Primary ID */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            ...
                            {isEditing ? (
                              ...
                              <div className="input bg-gray-50">
                                <span className={profile.primary_id_type ? 'text-gray-600' : 'text-gray-400 italic'}>
                          ...
                          <div>
                            ...
                            {isEditing ? (
                              ...
                              <div className="input bg-gray-50">
                                <span className={profile.primary_id_number ? 'text-gray-600' : 'text-gray-400 italic'}>
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <div className="input bg-gray-50">
                              <span className={profile.primary_id_expiry ? 'text-gray-600' : 'text-gray-400 italic'}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                              <div>
                                ...
                                {isEditing ? (
                                  ...
                                  <div className="input bg-gray-50">
                                    <span className={profile.organization_representative_name ? 'text-gray-600' : 'text-gray-400 italic'}>
                              ...
                              <div>
                                ...
                                {isEditing ? (
                                  ...
                                  <div className="input bg-gray-50">
                                    <span className={profile.organization_representative_position ? 'text-gray-600' : 'text-gray-400 italic'}>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              ...
                              {isEditing ? (
                                ...
                                <div className="input bg-gray-50">
                                  <span className={profile.secondary_id_type ? 'text-gray-600' : 'text-gray-400 italic'}>
                            ...
                            <div>
                              ...
                              {isEditing ? (
                                ...
                                <div className="input bg-gray-50">
                                  <span className={profile.secondary_id_number ? 'text-gray-600' : 'text-gray-400 italic'}>
                            ...
                            <div className="space-y-4">
                              {idImagePreview ? (
                                ...
                                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                                  ...
                                  <p className="text-gray-900 mb-2">Upload ID Image</p>
                            ...
                            {isEditing ? (
                              <div className="space-y-4">
                                {secondaryIdImagePreview ? (
                                  ...
                                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                                    <Camera className="h-12 w-12 text-blue-400 mx-auto mb-4" />
                                    <p className="text-gray-900 mb-2">Upload Representative ID</p>
                                    <p className="text-sm text-gray-600 mb-4">
                ...
                >
                  {profile.role === 'donor' && (
                    ...
                    <div className="border-b border-gray-200 pb-4 mb-6">
                      ...
                      <p className="text-sm text-gray-600 mt-1">Provide details about your donations and preferences</p>
                    </div>
                    ...
                    <div className="space-y-8">
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <div className="input bg-gray-50">
                            <span className={profile.emergency_contact_name ? 'text-gray-600' : 'text-gray-400 italic'}>
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <div className="input bg-gray-50">
                            <span className={profile.emergency_contact_phone ? 'text-gray-600' : 'text-gray-400 italic'}>
                ...
                {profile.role === 'recipient' && (
                  ...
                  >
                    <div className="border-b border-gray-200 pb-4 mb-6">
                      ...
                      <p className="text-sm text-gray-600 mt-1">Provide details about your needs and assistance requirements</p>
                    </div>
                    ...
                    <div className="space-y-8">
                      ...
                      {(watchedAccountType || profile.account_type) === 'organization' && (
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <div className="input bg-gray-50">
                              <span className={profile.organization_name ? 'text-gray-600' : 'text-gray-400 italic'}>
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <div className="input bg-gray-50">
                            <span className={profile.household_size ? 'text-gray-600' : 'text-gray-400 italic'}>
                        ...
                        {isEditing ? (
                          ...
                          <div className="flex flex-wrap gap-2">
                            {profile.assistance_needs && profile.assistance_needs.length > 0 ? (
                              ...
                              <span className="text-blue-500 text-sm">None specified</span>
                            )}
                          </div>
                        )}
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <div className="input bg-gray-50 h-32 overflow-y-auto custom-scrollbar">
                            <span className={profile.bio ? 'text-gray-600' : 'text-gray-400 italic'}>
